 ...
 * with (err).
 */
ProcessManager.prototype._startProcess = function(options, callback) {
 ...
 * found.
 */
ProcessManager.prototype._waitForStdout = function(obj, options, callback) {
  var stdoutBuffer = '';
 ...
 * established.
 */
ProcessManager.prototype._waitForSocket = function(obj, options, callback) {
