...
function getReporter(name, type, tests, options) {
...
function getTestReporter(name, tests, options) {
  return getReporter(name, 'test', tests, options);
}

function getCoverageReporter(name, tests, options) {
  return getCoverageReporter(name, 'coverage', tests, options);
}
...
exports.getTestReporter = getTestReporter;
exports.getCoverageReporter = getCoverageReporter;
