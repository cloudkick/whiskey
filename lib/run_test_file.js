...
var chdir = (!testUtil.isNullOrUndefined(process.argv[4])) ? process.argv[4] : null;
var testInitFile = (!testUtil.isNullOrUndefined(process.argv[5])) ? process.argv[5] : null;
var timeout = (!testUtil.isNullOrUndefined(process.argv[6])) ? parseInt(process.argv[6], 0) : null;
var concurrency = (!testUtil.isNullOrUndefined(process.argv[7])) ? parseInt(process.argv[7], 10) : null;
