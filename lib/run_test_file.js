...
var chdir = (!testUtil.isNullOrUndefined(process.argv[6])) ? process.argv[6] : null;
var customAssertModule = (!testUtil.isNullOrUndefined(process.argv[7])) ? process.argv[7] : null;
var testInitFile = (!testUtil.isNullOrUndefined(process.argv[8])) ? process.argv[8] : null;
var timeout = (!testUtil.isNullOrUndefined(process.argv[9])) ? parseInt(process.argv[9], 0) : null;
var concurrency = (!testUtil.isNullOrUndefined(process.argv[10])) ? parseInt(process.argv[10], 10) : null;
