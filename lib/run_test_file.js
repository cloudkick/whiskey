...
var testInitFile = (process.argv.length >= 5) ? process.argv[4] : null;
var timeout = (process.argv.length >= 6) ? parseInt(process.argv[5], 0) : null;
var concurrency = (process.argv.length === 7) ? parseInt(process.argv[6], 10) : null;
