...
function TestRunner(options) {
  ...
  if (global_setup_teardown_file) {
    console.error("--> global_setup_teardown_file("+global_setup_teardown_file+")");
    // Req 20
...
TestRunner.prototype.runTests = function(testInitFile, chdir,
  ...
  function onBound() {
    ...
    async.series([
//      self._global_setup_procedure.bind(null),
      self._testReporter.handleTestsStart.bind(self),
