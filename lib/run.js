...
function TestRunner(options) {
  ...
  this._global_setup_procedure = ignored;     // Req 50
  this._global_teardown_procedure = ignored;  // Req 60
  ...
  if (global_setup_teardown_file) {
    ...
    // Req 20
    var gst_exports = require(global_setup_teardown_file);
  ...
  function _run_global_setup() {
    ...
    test.run(function(results) {
      if(results.status !== 'success') {
        console.error("STATUS("+results.status+")");
