...
function TestRunner(options) {
  ...
  this._globalSetupProcedure = noop;
  this._globalTeardownProcedure = noop;
...
TestRunner.prototype.runTests = function(testInitFile, chdir,
  ...
  function _run_global_setup() {
    var test = new common.Test(constants.GLOBAL_SETUP_FUNCTION_NAME, self._globalSetupProcedure, false);
  ...
  function _run_global_teardown() {
    var test = new common.Test(constants.GLOBAL_TEARDOWN_FUNCTION_NAME, self._globalTeardownProcedure, false);
