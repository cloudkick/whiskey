...
function patchStdoutAndStderr(stdoutFunc, stderrFunc) {
  process.stdout.write = stdoutFunc;
  process.stderr.write = stderrFunc;
}
...
exports.patchStdoutAndStderr = patchStdoutAndStderr;
