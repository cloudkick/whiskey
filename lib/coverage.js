 ...
 */
function omfg(msg) {
  fs.open('/tmp/log.txt', 'a', 666, function( e, id ) {
...
function installCoverageHandler() {
  ...
  function writeCoverage() {
    ...
    _$jscoverage = __coverage__
    if (typeof _$jscoverage === 'object') {
      // Black Magic to make __coverage__ look like JSCoverage's _$jscoverage happens here.
